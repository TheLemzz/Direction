...
namespace CityGen
{
    public class CityGenerator : MonoBehaviour
    {
                ...
                if (exitPositipon != null)
                {
                    ...
                    switch (i)
                    {
                        case 8:
                            ...
                            block = Instantiate(forward400[Random.Range(0, forward400.Length)], exitPositipon.position, Quaternion.Euler(0, 0, 0), cityMaker.transform);
                            block = Instantiate(forward400[Random.Range(0, forward400.Length)], exitPositipon.position + (exitPositipon.forward * 400), Quaternion.Euler(0, 0, 0), cityMaker.transform);
                            block = Instantiate(forward400[Random.Range(0, forward400.Length)], exitPositipon.position + (exitPositipon.forward * 800), Quaternion.Euler(0, 0, 0), cityMaker.transform);
                            break;

                        case 7:

                            GenerateStreetsVerySmall(false, false, true, -300, -1516);
                            block = Instantiate(forwardRight400[Random.Range(0, forwardRight400.Length)], exitPositipon.position, Quaternion.Euler(0, 0, 0), cityMaker.transform);
                            block = Instantiate(forwardRight400[Random.Range(0, forwardRight400.Length)], exitPositipon.position + (exitPositipon.forward * 400) + (exitPositipon.right * 100), Quaternion.Euler(0, 0, 0), cityMaker.transform);
                            block = Instantiate(forwardRight400[Random.Range(0, forwardRight400.Length)], exitPositipon.position + (exitPositipon.forward * 800) + (exitPositipon.right * 200), Quaternion.Euler(0, 0, 0), cityMaker.transform);
                            break;
                        ...
                        case 6:
                            ...
                            block = Instantiate(forward400[Random.Range(0, forward400.Length)], exitPositipon.position, Quaternion.Euler(0, 0, 0), cityMaker.transform);
                            block = Instantiate(forwardLeft400[Random.Range(0, forwardLeft400.Length)], exitPositipon.position + (exitPositipon.forward * 400), Quaternion.Euler(0, 0, 0), cityMaker.transform);
                            block = Instantiate(forwardLeft400[Random.Range(0, forwardLeft400.Length)], exitPositipon.position + (exitPositipon.forward * 800) - (exitPositipon.right * 100), Quaternion.Euler(0, 0, 0), cityMaker.transform);
                            break;
                        ...
                        case 5:
                            ...
                            block = Instantiate(forwardRight400[Random.Range(0, forwardRight400.Length)], exitPositipon.position, Quaternion.Euler(0, 0, 0), cityMaker.transform);
                            block = Instantiate(forwardRight400[Random.Range(0, forwardRight400.Length)], exitPositipon.position + (exitPositipon.forward * 400) + (exitPositipon.right * 100), Quaternion.Euler(0, 0, 0), cityMaker.transform);
                            block = Instantiate(forwardLeft400[Random.Range(0, forwardRight400.Length)], exitPositipon.position + (exitPositipon.forward * 800) + (exitPositipon.right * 200), Quaternion.Euler(0, 0, 0), cityMaker.transform);
                            break;

                        case 4:

                            GenerateStreetsVerySmall(false, false, true, 700, -1316);
                            block = Instantiate(left300[Random.Range(0, left300.Length)], exitPositipon.position, Quaternion.Euler(0, 0, 0), cityMaker.transform);
                            block = Instantiate(right300[Random.Range(0, right300.Length)], exitPositipon.position + (exitPositipon.forward * 300) - (exitPositipon.right * 300), Quaternion.Euler(0, 270, 0), cityMaker.transform);
                            block = Instantiate(forwardLeft400[Random.Range(0, forwardRight400.Length)], exitPositipon.position + (exitPositipon.forward * 600) - (exitPositipon.right * 600), Quaternion.Euler(0, 0, 0), cityMaker.transform);
                            break;
                        ...
                        case 3:
                            ...
                            block = Instantiate(left300[Random.Range(0, left300.Length)], exitPositipon.position, Quaternion.Euler(0, 0, 0), cityMaker.transform);
                            block = Instantiate(right300[Random.Range(0, right300.Length)], exitPositipon.position + (exitPositipon.forward * 300) - (exitPositipon.right * 300), Quaternion.Euler(0, 270, 0), cityMaker.transform);
                            block = Instantiate(forwardRight400[Random.Range(0, forwardRight400.Length)], exitPositipon.position + (exitPositipon.forward * 600) - (exitPositipon.right * 600), Quaternion.Euler(0, 0, 0), cityMaker.transform);
                            break;

                        case 2:

                            GenerateStreetsVerySmall(false, false, true, -700, -1316);
                            block = Instantiate(right300[Random.Range(0, right300.Length)], exitPositipon.position, Quaternion.Euler(0, 0, 0), cityMaker.transform);
                            block = Instantiate(left300[Random.Range(0, left300.Length)], exitPositipon.position + (exitPositipon.forward * 300) + (exitPositipon.right * 300), Quaternion.Euler(0, 90, 0), cityMaker.transform);
                            block = Instantiate(forwardRight400[Random.Range(0, forwardRight400.Length)], exitPositipon.position + (exitPositipon.forward * 600) + (exitPositipon.right * 600), Quaternion.Euler(0, 0, 0), cityMaker.transform);
                            break;
                        ...
                        default:
                            ...
                            block = Instantiate(right300[Random.Range(0, right300.Length)], exitPositipon.position, Quaternion.Euler(0, 0, 0), cityMaker.transform);
                            block = Instantiate(left300[Random.Range(0, left300.Length)], exitPositipon.position + (exitPositipon.forward * 300) + (exitPositipon.right * 300), Quaternion.Euler(0, 90, 0), cityMaker.transform);
                            block = Instantiate(forwardLeft400[Random.Range(0, forwardLeft400.Length)], exitPositipon.position + (exitPositipon.forward * 600) + (exitPositipon.right * 600), Quaternion.Euler(0, 0, 0), cityMaker.transform);
                            break;
                    }

                }
                else Debug.Log("ExitCity gameobject not found");
            }

            DayNight dayNight = FindObjectOfType<DayNight>();
            if (dayNight) dayNight.ChangeMaterial();
        }

        private Transform CityExitPosition()
        {
            GameObject exit = GameObject.Find("ExitCity");
        ...
        private bool GenerateStreetsVerySmall(bool borderFlat = false, bool withSatteliteCity = false, bool satteliteCity = false, float satteliteCityPositionX = 0, float satteliteCityPositionZ = 0)
        {
            ...
            int nb = Random.Range(0, le);

            if (satteliteCity && smallBorderWithExitOfCity.Length > 0)
                block = Instantiate(largeBlocks[nb], CityExitPosition().position + new Vector3(satteliteCityPositionX, 0, satteliteCityPositionZ) - new Vector3(0, 0, 0), Quaternion.Euler(0, 0, 0), cityMaker.transform);
            else
                block = Instantiate(largeBlocks[nb], new Vector3(0, 0, 0), Quaternion.Euler(0, 0, 0), cityMaker.transform);


            if ((withSatteliteCity || satteliteCity) && miniBorderWithExitOfCity.Length > 0)
            {
                if (satteliteCity)
                    block = Instantiate(miniBorderWithExitOfCity[Random.Range(0, miniBorderWithExitOfCity.Length)], CityExitPosition().position + new Vector3(satteliteCityPositionX, 0, satteliteCityPositionZ), Quaternion.Euler(0, 180, 0), cityMaker.transform);
                else
                    block = Instantiate(miniBorderWithExitOfCity[Random.Range(0, miniBorderWithExitOfCity.Length)], new Vector3(0, 0, 0), Quaternion.Euler(0, 0, 0), cityMaker.transform);
            }
            else
            {
                if (borderFlat)
                    block = Instantiate(miniBorderFlat[Random.Range(0, miniBorderFlat.Length)], new Vector3(0, 0, 0), Quaternion.Euler(0, 0, 0), cityMaker.transform);
                else
                    block = Instantiate(miniBorder[Random.Range(0, miniBorder.Length)], new Vector3(0, 0, 0), Quaternion.Euler(0, 0, 0), cityMaker.transform);
            }
        ...
        private bool GenerateStreetsSmall(bool borderFlat = false, bool withSatteliteCity = false, bool satteliteCity = false)
        {
            ...
            {
                if (satteliteCity)
                    block = Instantiate(smallBorderWithExitOfCity[Random.Range(0, smallBorderWithExitOfCity.Length)], CityExitPosition().position + new Vector3(-0, 0, -1516), Quaternion.Euler(0, 180, 0), cityMaker.transform);
                else
                    block = Instantiate(smallBorderWithExitOfCity[Random.Range(0, smallBorderWithExitOfCity.Length)], new Vector3(0, 0, 0), Quaternion.Euler(0, 0, 0), cityMaker.transform);

            }
            else
            {
                if (borderFlat)
                    block = Instantiate(smallBorderFlat[Random.Range(0, smallBorderFlat.Length)], new Vector3(0, 0, 0), Quaternion.Euler(0, 0, 0), cityMaker.transform);
                else
                    block = Instantiate(smallBorder[Random.Range(0, smallBorder.Length)], new Vector3(0, 0, 0), Quaternion.Euler(0, 0, 0), cityMaker.transform);
            }
        ...
        private bool GenerateStreets(bool borderFlat = false, bool withSatteliteCity = false, bool satteliteCity = false)
        {
            ...
            if ((withSatteliteCity || satteliteCity) && mediumBorderWithExitOfCity.Length > 0)
                block = Instantiate(mediumBorderWithExitOfCity[Random.Range(0, mediumBorderWithExitOfCity.Length)], new Vector3(0, 0, 0), Quaternion.Euler(0, 0, 0), cityMaker.transform);
            else
            {
                if (borderFlat)
                    block = Instantiate(mediumBorderFlat[Random.Range(0, mediumBorderFlat.Length)], new Vector3(0, 0, 0), Quaternion.Euler(0, 0, 0), cityMaker.transform);
                else
                    block = Instantiate(mediumBorder[Random.Range(0, mediumBorder.Length)], new Vector3(0, 0, 0), Quaternion.Euler(0, 0, 0), cityMaker.transform);
            }
        ...
        private bool GenerateStreetsBig(bool borderFlat = false, bool withSatteliteCity = false, bool satteliteCity = false)
        {
            ...
            if ((withSatteliteCity || satteliteCity) && largeBorderWithExitOfCity.Length > 0)
                block = Instantiate(largeBorderWithExitOfCity[Random.Range(0, largeBorderWithExitOfCity.Length)], new Vector3(0, 0, 0), Quaternion.Euler(0, 0, 0), cityMaker.transform);
            else
            {
                if (borderFlat)
                    block = Instantiate(largeBorderFlat[Random.Range(0, largeBorderFlat.Length)], new Vector3(0, 0, 0), Quaternion.Euler(0, 0, 0), cityMaker.transform);
                else
                    block = Instantiate(largeBorder[Random.Range(0, largeBorder.Length)], new Vector3(0, 0, 0), Quaternion.Euler(0, 0, 0), cityMaker.transform);
        ...
        public bool CreateBuildingsInCorners(GameObject child, bool notAnyone = false)
        {
            ...
            pBuilding = Instantiate(pB, new Vector3(0, 0, 0), Quaternion.Euler(0, 0, 0));
        ...
        private void CreateBuildingsInLine(GameObject line, float angulo, bool slope = false)
        {
            ...
            while (tt < 100)
            {
                ...
                else
                {
                    ...
                    pBuilding[index] = Instantiate(pB, new Vector3(0, 0, init + (pWidth * 0.5f)), Quaternion.Euler(0, angulo, 0), line.transform);
        ...
        private void CreateBuildingsInDoubleLine(GameObject line)
        {
            ...
            while (tt < 100)
            {
                ...
                else
                {
                    ...
                    pBuilding[index] = Instantiate(MB[numB], new Vector3(0, 0, 0), Quaternion.Euler(0, 90, 0), line.transform);
            ...
            foreach (GameObject dbCross in tempArray)
            {
                ...
                foreach (Transform line in dbCross.transform)
                {
                    ...
                    if (Random.Range(0, 10) < 5)
                    {
                        ...
                        GameObject e = Instantiate(DC[numB], line.transform.position, line.transform.rotation, line.transform);
                        ...
                        e = Instantiate(DC[numB], line.transform.position, line.rotation, line.transform);
