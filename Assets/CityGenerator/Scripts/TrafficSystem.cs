...
namespace CityGen
{
    ...
    public class TrafficSystem : MonoBehaviour
    {
        ...
        [Range(10, 1000), SerializeField] private int maxVehicle;
        ...
        private readonly ArrayList spawnsPoints;
        ...
        private readonly WpData wpData = new WpData();
        ...
        public void LoadCars(int right_Hand = 0)
        {
            ...
            for (int j = 0; j < n; j++)
            {
                ...
                else
                {
                    ...
                    if (go)
                    {
                        ...
                        vehicle = Instantiate(IaCars.PickRandomElement(), wpDataSpawn[i].position + (Vector3.up * 0.1f), wpDataSpawn[i].rotation); ;
